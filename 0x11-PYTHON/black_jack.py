...
def black_jack():
    ...
    while flag != False:
        ...
        if choose == "y":
            ...
            print(f"Your final hand is {user_card}\nYour final"
                  "score is {calculate_score(user_card)}")
            print(f"The computer's final hand is {computer_card}\nThe computer's"
                  "final score is {calculate_score(computer_card)}")
    ...
    compare(user_score=user_card, computer_score=computer_card)
    # passing user and computer's card to the compare function
